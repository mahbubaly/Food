        ...
        <>
            <div className='container mx-auto'>
                ...
                <div className='lg:-mt-[300px]  xl:ml-80  lg:ml-48 lg:p-0 p-5  justify-center lg:flex items-center'>
                    ...
                    <div data-aos="fade-down"  data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="600"  className='awards  xl:p-11 lg:p-4 p-5 mt-4 lg:mt-10  '>
                    ...
                    <img data-aos="fade-up"  data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="600" className='lg:mt-0 mt-6' src={img2} alt="" />
                </div>
            </div>
