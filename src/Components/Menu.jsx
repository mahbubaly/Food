        ...
        <>
            <div className='container mx-auto menu rounded-lg mt-32 px-[60px] py-[120px] bg-black text-white '>
                ...
                <div className='lg:flex mt-[90px]'>
                    <div className='menu-items mr-[62px] text-center px-3 py-[30px] w-[190px] lg:mx-0 mx-auto   box-menu hover:duration-1000'>
                    ...
                    <div className='grid lg:grid-cols-3 grid-cols-1 lg:mt-0 mt-5'>
                        <div className='menu-items p-5  box-menu hover:duration-1000 mr-[30px] lg:ml-6'>
                        ...
                        <div className='menu-items p-5  box-menu hover:duration-1000 mr-[30px] lg:my-0 my-5'>
                        ...
                        <div className='menu-items p-5 box-menu hover:duration-1000 '>
