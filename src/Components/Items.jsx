    ...
    return (
        <>
            <div className='lg:p-[60px]'>
                <div className='container mx-auto p-20   xl:-mt-[400px] -mt-[550px] bg-slate-100 rounded-xl'>
                    ...
                    <div className='md:flex  gap-10 mt-8'>
                        ...
                        <div className='grid xl:grid-cols-2 lg:grid-cols-1 items-center  lg:gap-5 xl:gap-[30px] bg-white py-[40px] px-[30px] rounded-lg'>
                            <div className='lg:order-2 xl:order-1'>
                            ...
                            <img className='mx-auto lg:order-1 xl:order-2' src={burger1} alt="" />
                        ...
                        <div className='grid xl:grid-cols-2 lg:grid-cols-1 items-center  lg:gap-5 xl:gap-[30px] bg-white py-[40px] px-[30px] rounded-lg'>
                            <div className='lg:order-2 xl:order-1'>
                                ...
                                <div className='flex justify-between gap-10 mt-6 items-center'>
                                    ...
                                    <Link> <button className='btn-all text-black mt-[25px] font-bold text-[16px] '>order now</button></Link>
                                </div>

                            </div>
                            <img className='mx-auto lg:order-1 xl:order-2' src={burger2} alt="" />
